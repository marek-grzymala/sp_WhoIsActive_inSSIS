...
IF OBJECT_ID (N'ufn_GetPackageHistAvg_Duration_PerPackageName_ExclOutliers', N'IF') IS NOT NULL
  DROP FUNCTION dbo.ufn_GetPackageHistAvg_Duration_PerPackageName_ExclOutliers
GO

CREATE FUNCTION ufn_GetPackageHistAvg_Duration_PerPackageName_ExclOutliers (@ProjectName NVARCHAR(256), @PackageName NVARCHAR(256), @DurationPercentileLower FLOAT, @DurationPercentileUpper FLOAT, @DaysBack INT, @EndDate DATETIME)
RETURNS TABLE
AS
RETURN
(
